...
Here, \(r_t\) is the future return, \(x_{t-1}\) is last period's dividend yield, and \(\beta\) measures the true forecasting relationship.
...
3. the return shock \(u_t\) and predictor shock \(v_t\) are correlated.
